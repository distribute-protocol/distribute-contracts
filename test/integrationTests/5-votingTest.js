...
contract('Voting State', (accounts) => {
  ...
  describe('voting with tokens', () => {
    ...
    it('Token Voter can commit vote to a validated task yes from RR validating project', async function () {})
    it('Reputation Voter can commit vote to a validated task yes from RR validating project', async function () {})
    it('Voter can commit vote to a validated task no from RR validating project', async function () {})
    it('Reputation can commit vote to a validated task no from RR validating project', async function () {})

    it('Voter can reveal yes vote on a validated task from TR validating project', async function () {})
    it('Reputation can reveal no vote on a validated task from from RR validating project', async function () {})
    it('Voter can reveal yes vote on a validated task from TR validating project', async function () {})
    it('Reputation can reveal no vote on a validated task from from RR validating project', async function () {})
  ...
  //
  //     // validate task
  //     await TR.voteCommit(projAddrT, indexYes, tokensToValidate, true, {from: validator1})
  //
