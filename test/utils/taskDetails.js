...
const task1 = {description: 'test description 1', weighting: 10}
...
const task5 = {description: 'test description 5', weighting: 50}
const task6 = {description: 'test description 6', weighting: 50}

const taskSet1 = [task1, task2, task3, task4]
const taskSet2 = [task5, task6]
